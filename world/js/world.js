class World {
    ...
    #generateTrees() {
        const points = [
            ...
            ...this.building.map((b) => b.base.points).flat()
        ];
    ...
    static load(info) {
        ...
        world.building = info.building.map((e) => Building.load(e));
    ...
    draw(ctx, viewPoint, showStartMarkings = true) {
        ...
        for (const seg of this.roadBorders) {
            seg.draw(ctx, { color: "white", width: 10 });
        }
        ...
        const items = [...this.building, ...this.trees]
